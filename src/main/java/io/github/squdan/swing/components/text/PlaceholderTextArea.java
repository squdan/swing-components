...
public class PlaceholderTextArea extends JTextArea {
    ...
    /**
     * Default {@link JTextArea} without placeholder.
     */
     ...
     */
    public PlaceholderTextArea(final String placeholder) {
     ...
     */
    public PlaceholderTextArea(final String placeholder, final String text) {
        super(text);
