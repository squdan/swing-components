...
/**
 * {@link CalendarDayCellRenderer} implementation that uses {@link JLabel} internally as value container.
 * <p>
 * This implementation manages String built from {@link CalendarDayCell} that shows the number of the day and
 * the number of elements into values field.
 */
public class CalendarDayJLabelCellRenderer extends DefaultTableCellRenderer implements CalendarDayCellRenderer {
    ...
    public Component getTableCellRendererComponent(final JTable table, final Object value, final boolean isSelected,
        ...
        if (Objects.nonNull(calendarDayCellValue)) {
            ...
            cellValue.append(NEW_LINE);
            cellValue.append(calendarDayCellValue.getValues().size() + ITEMS_DESC);
