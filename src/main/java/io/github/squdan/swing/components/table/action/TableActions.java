...
/**
 * Default table actions that user can apply over each cell into {@link io.github.squdan.swing.components.table.TablePanel}.
 *
 * @param <T> Data type.
...
public class TableActions<T> {
    ...
    /**
     * Method used at {@link io.github.squdan.swing.components.table.TablePanel} when some {@link java.awt.event.ActionEvent} is caught.
     *
     ...
     * @param columnInfo {@link io.github.squdan.swing.components.table.model.ColumnInfo} from selected cell from user.
    ...
    /**
     * Method used at {@link io.github.squdan.swing.components.table.TablePanel} to detect available actions
